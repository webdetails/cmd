 ...
 */
package pt.webdetails.cdf.mobile.navigator;
...
public class WcdfFileNavigator extends PentahoBase {
    ...
    protected static final Log logger = LogFactory.getLog(WcdfFileNavigator.class);
    ...
    public WcdfFileNavigator(final IPentahoSession userSession, String contextPath) {
    ...
    public String getWcdfFilelist(final String mode, final String solution, final String path) throws JSONException, ParserConfigurationException {
            ...
            if (parentPathArray.length > 0) {
                for (final Object node1 : nodes) {
                    ...
                    if (visible && isDirectory) {
                        ...
                        final List fileNodes = node.selectNodes("./file[@isDirectory='false'][ends-with(string(@name),'.wcdf')]");
